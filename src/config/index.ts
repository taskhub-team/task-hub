...
export interface AppConfig {
  environment: 'development' | 'preview1' | 'preview2' | 'production';
  apiUrl: string;
...
const environment =
  (import.meta.env.VITE_ENVIRONMENT as AppConfig['environment']) ||
  'development';
const apiUrl =
  (import.meta.env.VITE_API_URL as string) || 'http://localhost:3000';
const loggingLevel =
  (import.meta.env.VITE_LOGGING_LEVEL as AppConfig['loggingLevel']) || 'debug';
